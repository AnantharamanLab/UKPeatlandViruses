...
```{r merge-reformat-save-env-data}
env_data <- CN %>%
...
- Ensures that environmental differences within each site are emphasized while controlling for broader site-level variation
    
```{r scale-env-data-by-site}
