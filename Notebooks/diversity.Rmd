...
```{r plot-map-with-eco-index, fig.width=3.543305, fig.height=2.75590}
...
```{r plot-PCoA, fig.width=3.543305, fig.height=2.75590}
...
```{r plot-PCoA-separated, fig.width=1.77165, fig.height=1.18110}
...
## Plot PCoA for hosts
```{r plot-PCoA-host, fig.width=3.543305, fig.height=2.75590}
...
### Make the plot
```{r plot-pcoa-eco-index, fig.width=3.543305, fig.height=2.75590}
...
```{r get-vals-eco-index-pcoa1-reg}
...
#### Make the plot
```{r plot-eco-index-pcoa1-reg, fig.width=3.543305, fig.height=2.75590}
...
```{r fig-1, fig.height=8.26772, fig.width=7.08661}
...
```{r combine-host-pcoa-and-combined-host-pcoa, fig.height=7.08661, fig.width=7.08661}
