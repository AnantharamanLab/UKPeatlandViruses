...
# Credit
Code for Principal Component Analyses were adapted by [**Kirsten Ball**](https://orcid.org/0000-0001-9632-0874) on 14 February 2023 from original script by [**Dr Laura Castaneda Gomez**](https://orcid.org/0000-0002-4167-4672) & **Kirsten Ball**, then further adapted for these data by James C. Kosmopoulos on 8 September 2023.
...
```{r plot-pca-merged, fig.width=7.08661, fig.height=7.08661}
plot.pca.env.merged <-
  cowplot::plot_grid(
    results_list[[1]][[4]] +
      theme(
