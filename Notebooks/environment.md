...
Ball**](https://orcid.org/0000-0001-9632-0874) on 14 February 2023 from
original script by [**Dr Laura Castaneda
...
plot_pca <- function(group, group_name){
  ...
  label_size <- ifelse(group_name == "All sites", 4, 3)
  axis_title_size <- ifelse(group_name == "All sites", 10, 8)
  ...
  cowplot::plot_grid(
    results_list[[1]][[4]] +
      theme(
        ...
        legend.justification = "center",
        plot.margin = unit(c(0.25, 3, 0, 0.25), "cm"),
        ...
        legend.margin = margin(t = 0.25, r = 0, b = 0.25, l = 2, unit = "cm"),
    ...
    cowplot::plot_grid(
      (results_list[[2]][[4]] +
         theme(text = element_text(size = 8), legend.position = "none",
              plot.margin = unit(c(0.5, 0.25, 0.2, 0.25), "cm"),
      ...
      (get_legend(
        (results_list[[1]][[4]] +
         ...
         labs(
           fill = "Ecosystem health\nstatus",
           color = "Ecosystem health\nstatus",
...
ggsave(plot.pca.env.merged,
       file="../Plots/environment/ExtendedDataFig1.png",
       device="png",
       dpi=600, units="in", height=7.08661, width=7.08661,
       scale = 1,
       bg = "white")
ggsave(plot.pca.env.merged,
       file="../Plots/environment/ExtendedDataFig1.svg",
       device="svg",
       dpi=600, units="in", height=7.08661, width=7.08661,
       scale = 1,
       bg = "white")
