...
```{r plot-virus-over-host, fig.height=2.83464, fig.width=7.08661}
...
```{r plot-lysogenic-tmeans, fig.height=2.83464, fig.width=7.08661}
...
```{r plot-normalized-lysogenic-abundance, fig.height=2.83464, fig.width=7.08661}
...
## Combine the plots
```{r combine-lysogenic-plots, fig.height=7.08661, fig.width=7.08661}
...
```{r lysogenic-abundance-just-all-sites, fig.height=2.83464, fig.width=2.834644}
...
### Plot it
```{r plot-lysogenic-abundance-over-eco-index-mean-norm, fig.height=2.83464, fig.width=4.251966}
p_raw <- m1_p  
...
```{r combine-lyosgenic-virus-plots, fig.height=2.83464, fig.width=7.08661}
...
```{r combine-lysogenic-and-virus-host, fig.height=5.66928, fig.width=7.08661}
